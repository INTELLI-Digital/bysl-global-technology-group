...
import { SectionTitleType, TextGradient } from "../shared/SharedTextgroups";
  ...
  return (
    <div className="py-10 xl:py-16 flex flex-col md:flex-row 2xl:gap-32">
      <div className="md:w-2/5">
        {/* <SectionTitleType title="FAQ" start={true} bold={true} /> */}
            ...
            <div className="mt-6 md:mt-7 first:mt-0">
              <Accordion open={open === id} onClick={() => handleOpen(id)}>
                <div className="flex justify-between">
                  <p className="text-[#282938] text-xl font-medium cursor-pointer">
                    {question}
                  </p>
                  <AiOutlinePlus
