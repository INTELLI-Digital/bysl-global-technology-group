...
const CompanySummary = () => {
  return (
    <div className="my-16 bg-gradient-to-r from-blue-900 to-blue-700 min-h-max 2xl:h-80 px-5 md:px-16 lg:px-20 2xl:px-32 py-10 text-center text-white rounded-xl lg:rounded-3xl 2xl:rounded-[40px]">
