...
const ApplicationForm = () => {
  const jobTitle = "Application Software Engineer";
  ...
  return (
    <CommonLayout title="Application Form">
      ...
      <CareersPreviewModal jobTitle={jobTitle} data={previewData} />
      <div className="max-w-[856px] mx-auto py-10 xl:py-16">
        <JobHeader jobTitle={jobTitle} />
        <form onSubmit={handleSubmit} className="max-w-[416px] mx-auto lg:pt-6">
          {/* name input  */}
